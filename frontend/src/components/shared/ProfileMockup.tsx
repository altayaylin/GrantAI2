...
export function ProfileMockup() {
  ...
  const universities = [
    { name: "MIT", chance: "18%", tier: "Reach", color: "text-red-400 bg-red-500/10 border-red-500/20" },
    { name: "ETH Zürich", chance: "42%", tier: "Match", color: "text-blue-400 bg-blue-500/10 border-blue-500/20" },
    { name: "TU Delft", chance: "64%", tier: "Match", color: "text-blue-400 bg-blue-500/10 border-blue-500/20" },
  ];
  ...
  return (
    <div className="relative w-full max-w-[480px] mx-auto lg:ml-auto">
      ...
      <div className="float-animation relative rounded-2xl border border-[var(--border)] bg-[var(--bg-card)]/80 backdrop-blur-xl p-6 shadow-2xl overflow-hidden">
        {/* Glow circle overlay */}
        ...
        <div className="flex items-center justify-between pb-5 border-b border-[var(--border)] mb-5">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h4 className="text-sm font-semibold text-[var(--text-primary)]">Алишер Н.</h4>
        ...
        <div className="mb-6">
          ...
          <div className="h-2 w-full bg-[var(--bg-base)] rounded-full overflow-hidden border border-[var(--border)]">
            <div className="h-full bg-gradient-to-r from-[var(--accent)] to-[var(--accent-secondary)] rounded-full" style={{ width: "72%" }} />
          </div>
        </div>
          ...
          <div className="space-y-2">
            {universities.map((uni, idx) => (
              <div key={idx} className="flex items-center justify-between px-3 py-2 rounded-lg bg-[var(--bg-base)]/30 border border-[var(--border)] hover:bg-[var(--bg-card-hover)] transition-colors">
                ...
                <div className="flex items-center gap-2">
                  <span className="text-[10px] font-mono-custom text-[var(--text-secondary)]">Шанс: {uni.chance}</span>
